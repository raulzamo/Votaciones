 ...
 * @author Raul
 */
public class ControladorAltaVotante extends HttpServlet {
 ...
 request.setCharacterEncoding("UTF-8");
        ...
        try {
            ...
            response.sendRedirect("VISTA/VistaIniciarSesion.jsp?registrado");
           ...
           response.sendRedirect("VISTA/VistaError.jsp");
            ...
            if(ex.getError() == 1062){
                response.sendRedirect("VISTA/VistaError.jsp?error=registrado");
            }else{
                response.sendRedirect("VISTA/VistaError.jsp");
            }
        }        
