 ...
 * @author Raul
 */
public class ControladorBorrarVotante extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String nif=OVotante.getNif();
           new Operaciones().borrarVotante(nif, Conexion);
            response.sendRedirect("VISTA/VistaMensaje.jsp?mensaje=borrado");
